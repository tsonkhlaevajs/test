 ...
 */
    ...
    (() => {
        ...
        const inputMasks = document.getElementsByClassName("phone-mask");
        ...
        function initSliders() {
            if (document.querySelector(".sliders-product__slider")) new core(".sliders-product__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                thumbs: {
                    swiper: {
                        el: ".sliders-product-thumbs__slider",
                        slidesPerView: 6
                    }
                },
                navigation: {
            ...
            if (document.querySelector(".sliders-product-thumbs__slider")) {
                new core(".sliders-product-thumbs__slider", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    autoHeight: true,
            ...
            if (document.querySelector(".slider-brands")) new core(".slider-brands", {
